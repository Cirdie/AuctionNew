...
{
    // Fetching the count of users grouped by city, excluding country and province
    $users = User::selectRaw('city, COUNT(*) as total')
        ->groupBy('city')
        ->orderBy('total', 'desc')
        ->get()
        ->take(10)  // You can adjust how many cities you want to take
        ->pluck('total', 'city')  // Pluck counts by city name
        ->all();
