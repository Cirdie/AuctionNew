...
class AdminAdRepository extends BaseCrudRepository implements AdminAdRepositoryInterface
{
    ...
    public function deleteAd(string $adSlug): void
    {
      ...
      public function createAsAdmin(array $data): Ad
    {
        return DB::transaction(function () use ($data) {

            $ad = $this->storeAsAdmin($data);

            $this->uploadMedia(
                $ad,
                $data['images'] ?? [],
                StorageDiskType::LOCAL,
                'public/ad',
                640,
                480
            );
    ...
    protected function storeAsAdmin(array $data): Ad
    {
        ...
        return $this->model->create([
            ...
            // Static Seller
            'seller_name'    => 'Bazaar Administrator',
            'seller_email'   => 'admin@bazaar.com',
            'seller_mobile'  => '09123456789',
            'seller_address' => 'Tagum City, Davao del Norte',
