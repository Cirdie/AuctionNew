                                ...
                                <div class="panel-body tabs-menu-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active show" id="tab5" role="tabpanel">
                                            ...
                                            <h4 class="mb-5 mt-3 fw-bold">Winning Bid :</h4>

<div class="table-responsive">
    <table class="table table-bordered">
        <tbody>
            <tr>
                <td class="fw-bold">Winning Bid Amount</td>
                <td>
    ...
    @foreach ($ad->bids as $bid)
        <tr>
            ...
            <td @class(['text-success' => $bid->is_accepted, 'text-danger' => $bid->is_accepted === false])>
                {{ is_null($bid->is_accepted) ? 'Pending' : ( $bid->is_accepted ? 'Accepted' : 'Reject' ) }}
            </td>
            <td>
                @if (is_null($bid->is_accepted) && !$ad->hasAcceptedBid())
                    <form action="{{ route('admin.bids.accept', ['adSlug' => $ad->slug, 'bidId' => $bid->id]) }}"
                          method="POST"
                          onsubmit="return confirm('Are you sure you want to accept this bid? This will mark the ad as sold.');">
                        @csrf
