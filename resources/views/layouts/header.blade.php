    ...
    <div class="container-fluid main-container">
      <div class="d-flex">
        ...
        <form action="{{route('admin.search')}}" class="main-header-center ms-3 d-none d-lg-block">
          ...
          <button type="submit" class="btn px-0 pt-2"><i class="fa-regular fa-magnifying-glass"></i></button>
        </form>
...
<header class="style-2">
    ...
    <div class="main-menu">
        ...
        <ul class="menu-list">
            ...
            <li><a href="{{ route('live-auction') }}">Live Auction</a></li>
