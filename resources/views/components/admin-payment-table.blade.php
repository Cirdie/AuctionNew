                                            ...
                                            <table id="data-table"
                                                ...
                                                <thead class="border-top">
                                                    <tr role="row">
                                                        <th class="bg-transparent border-bottom-0 sorting"
                                                            ...
                                                            colspan="1" aria-label="Transaction ID">
                                                            Transaction ID
                                                        </th>
                                                        <th class="bg-transparent border-bottom-0 sorting"
                                                            tabindex="0" aria-controls="data-table" rowspan="1"
                                                            colspan="1" aria-label="Payer">
                                                            Payer
                                                        </th>
                                                        <th class="bg-transparent border-bottom-0 sorting"
                                                            tabindex="0" aria-controls="data-table" rowspan="1"
                                                            colspan="1" aria-label="Payee">
                                                            Payee
                                                        </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="border-bottom odd">
                                                        <td>
                                                            <span class="copy-text" onclick="copyTransactionID('{{$payment->txn_id}}')">{{$payment->txn_id}}</span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="">
                                                            <div class="mt-sm-1 d-block">
                                                                <span
                                                                    class="badge bg-{{$payment->payment_method == 'GCASH' ? 'primary' : 'secondary'}}-transparent rounded-pill text-{{$payment->payment_method == 'GCASH' ? 'primary' : 'secondary'}} p-2 px-3">
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <a class="btn text-primary btn-sm"
                                                                    data-bs-target="#select2modal" data-bs-toggle="modal"
                                                                    href="javascript:;"
